...
const allAvailableShopItems = [
    ...
    { id: "avatar_smile_face", name: "Smile Face", description: "Smile, sometimes.", cost: 10, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_smile_face"], type: "avatar" },
    { id: "avatar_smiling_cat", name: "Smiling Cat", description: "Who doesn't love a smiling cat?", cost: 20, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_smiling_cat"], type: "avatar" },
    { id: "avatar_cool_dog", name: "Cool Dog", description: "Dogs >> cats and cool dogs >> dogs, that's simple math", cost: 20, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_cool_dog"], type: "avatar" },
    { id: "avatar_mainstream_girl", name: "Mainstream Girl", description: "A standard female profile, a little boring", cost: 20, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_mainstream_girl"], type: "avatar" },
    { id: "avatar_mainstream_guy", name: "Mainstream Guy", description: "A standard male profile, a little boring", cost: 20, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_mainstream_guy"], type: "avatar" },
    { id: "avatar_bored_guy", name: "A Bored Guy", description: "Just a bored guy", cost: 25, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_bored_guy"], type: "avatar" },
    { id: "avatar_bored_girl", name: "A Bored Girl", description: "Just a bored girl", cost: 25, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_bored_girl"], type: "avatar" },
    { id: "avatar_concentrated_guy", name: "A Concentrated Guy", description: "sssh, I'm trying to concentrate", cost: 30, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_concentrated_guy"], type: "avatar" }, // Corrected ID, using a new placeholder URL key
    { id: "avatar_concentrated_girl", name: "A Concentrated Girl", description: "sssh, I'm trying to concentrate", cost: 30, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_concentrated_girl"], type: "avatar" }, // Corrected ID, using a new placeholder URL key
    { id: "avatar_nerd_guy", name: "The Nerd Guy", description: "I like studying and I wear glasses, but that doesn't mean I'm a nerd", cost: 30, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_nerd_guy"], type: "avatar" },
    { id: "avatar_nerd_girl", name: "The Nerd Girl", description: "I like studying and I wear glasses, but that doesn't mean I'm a nerd", cost: 30, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_nerd_girl"], type: "avatar" },
    { id: "avatar_cheeky_monkey", name: "Cheeky Monkey", description: "A playful monkey face.", cost: 40, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_cheeky_monkey"], type: "avatar" },
    { id: "avatar_cool_guy", name: "The (fake) Cool Guy", description: "Where's the party?", cost: 40, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_cool_guy"], type: "avatar" },
    { id: "avatar_cool_girl", name: "The (fake) Cool Girl", description: "Do you think I'm pretty? Of course, everyone thinks so", cost: 40, rarity: shopTypes_1.ItemRarity.Mainstream, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_cool_girl"], type: "avatar" },
    // --- Quite Common (10 items) ---
    { id: "avatar_student_girl", name: "Sleepy Student Girl", description: "Too many late-night study sessions.", cost: 60, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_student_girl"], type: "avatar" },
    { id: "avatar_student_guy", name: "Sleepy Student Guy", description: "Too many late-night study sessions.", cost: 60, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_student_guy"], type: "avatar" }, // Corrected ID, using a new placeholder URL key
    { id: "avatar_addicted_caffe_guy", name: "Caffeine Addict Guy", description: "Runs on coffee and anxiety.", cost: 60, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_addicted_caffe_guy"], type: "avatar" },
    { id: "avatar_addicted_caffe_girl", name: "Caffeine Addict Girl", description: "Runs on coffee and anxiety.", cost: 60, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_addicted_caffe_girl"], type: "avatar" }, // Corrected ID, using a new placeholder URL key
    { id: "avatar_chill_guy", name: "Just Chillin' Guy", description: "Productivity? Maybe later.", cost: 75, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_chill_guy"], type: "avatar" },
    { id: "avatar_chill_girl", name: "Just Chillin' Girl", description: "Productivity? Maybe later.", cost: 75, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_chill_girl"], type: "avatar" }, // Corrected ID
    { id: "avatar_sport_guy", name: "Sporty Guy", description: "Break time is gym time.", cost: 75, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_sport_guy"], type: "avatar" },
    { id: "avatar_sport_girl", name: "Sporty Girl", description: "Active, focused, unstoppable.", cost: 75, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_sport_girl"], type: "avatar" },
    { id: "avatar_mysterious_stranger", name: "Mysterious Stranger", description: "Nobody really knows him.", cost: 80, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_mysterious_stranger"], type: "avatar" },
    { id: "avatar_eyes", name: "The eyes that know", description: "She knows too much.", cost: 80, rarity: shopTypes_1.ItemRarity.QuiteCommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_eyes"], type: "avatar" },
    // --- Uncommon (10 items) ---
    { id: "avatar_night_girl", name: "Night Owl Girl", description: "Productive only after midnight.", cost: 100, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_night_girl"], type: "avatar" },
    { id: "avatar_night_guy", name: "Night Owl Guy", description: "Productive only after midnight.", cost: 100, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_night_guy"], type: "avatar" }, // Corrected ID, using a new placeholder URL key
    { id: "avatar_early_bird_girl", name: "Early Bird Girl", description: "Wakes up at 5AM. By choice.", cost: 100, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_early_bird_girl"], type: "avatar" },
    { id: "avatar_early_bird_guy", name: "Early Bird Guy", description: "Wakes up at 5AM. By choice.", cost: 100, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_early_bird_guy"], type: "avatar" }, // Corrected ID, using a new placeholder URL key
    { id: "avatar_zen_cat", name: "Zen Cat", description: "Meditates between tasks.", cost: 115, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_zen_cat"], type: "avatar" },
    { id: "avatar_minimalist_girl", name: "Minimalist Girl", description: "Less is more.", cost: 120, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_minimalist_girl"], type: "avatar" }, // Corrected ID
    { id: "avatar_minimalist_guy", name: "Minimalist Guy", description: "Less is more.", cost: 120, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_minimalist_guy"], type: "avatar" },
    { id: "avatar_shadow", name: "The Shadow", description: "Silent but efficient.", cost: 130, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_shadow"], type: "avatar" }, // Corrected ID
    { id: "avatar_robot", name: "Robot Assistant", description: "Not sentient... yet.", cost: 135, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_robot"], type: "avatar" },
    { id: "avatar_nature_entity", name: "Nature Entity", description: "Feeling the wind", cost: 145, rarity: shopTypes_1.ItemRarity.Uncommon, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_nature_entity"], type: "avatar" },
    // --- Rare (7 items) ---
    { id: "avatar_king_focus", name: "Knight of Focus", description: "Defender of deadlines.", cost: 200, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_king_focus"], type: "avatar" },
    { id: "avatar_task_widzard", name: "Task Wizard", description: "Turns to-dos into done.", cost: 220, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_task_widzard"], type: "avatar" },
    { id: "avatar_futurist", name: "Futurist", description: "Already planning for next year.", cost: 230, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_futurist"], type: "avatar" },
    { id: "avatar_desert_wolf", name: "Desert Wolf", description: "Alone, but never idle.", cost: 240, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_desert_wolf"], type: "avatar" },
    { id: "avatar_lady_noire", name: "Lady Noir", description: "Elegant, focused, untouchable.", cost: 250, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_lady_noire"], type: "avatar" },
    { id: "avatar_hermit", name: "Mountain Hermit", description: "Lives alone. Works a lot.", cost: 260, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_hermit"], type: "avatar" },
    { id: "avatar_masked_planned", name: "The Masked Planner", description: "Has a plan for everything.", cost: 270, rarity: shopTypes_1.ItemRarity.Rare, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_masked_planned"], type: "avatar" },
    // --- Special (5 items) ---
    { id: "avatar_elf", name: "Digital Elf", description: "Boosts your motivation with magic.", cost: 400, rarity: shopTypes_1.ItemRarity.Special, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_elf"], type: "avatar" },
    { id: "avatar_star_commander", name: "Star Commander", description: "Leads galactic productivity fleets.", cost: 420, rarity: shopTypes_1.ItemRarity.Special, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_star_commander"], type: "avatar" },
    { id: "avatar_mind_reader", name: "Mind Reader", description: "Knows your tasks before you do.", cost: 440, rarity: shopTypes_1.ItemRarity.Special, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_mind_reader"], type: "avatar" },
    { id: "avatar_phoenix", name: "Phoenix Soul", description: "Rises from procrastination ashes.", cost: 460, rarity: shopTypes_1.ItemRarity.Special, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_phoenix"], type: "avatar" },
    { id: "avatar_time_bender", name: "The Time Bender", description: "Can manipulate time... for deadlines.", cost: 480, rarity: shopTypes_1.ItemRarity.Special, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_time_bender"], type: "avatar" },
    // --- Legendary (3 items) ---
    { id: "avatar_cosmic_entity", name: "Cosmic Entity", description: "A being of immense power.", cost: 2500, rarity: shopTypes_1.ItemRarity.Legendary, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_cosmic_entity"], type: "avatar" },
    { id: "avatar_chrono_panthern", name: "Chrono Panther", description: "A legendary creature of absolute punctuality.", cost: 3000, rarity: shopTypes_1.ItemRarity.Legendary, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_chrono_panthern"], type: "avatar" },
    { id: "avatar_lord_time", name: "Lord of Time", description: "Absolute control over chronology.", cost: 2800, rarity: shopTypes_1.ItemRarity.Legendary, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_lord_time"], type: "avatar" },
    // --- Unique (2 items - Male/Female) ---
    { id: "avatar_architect", name: "The Architect", description: "The master builder of realities.", cost: 5000, rarity: shopTypes_1.ItemRarity.Unique, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_architect"], type: "avatar" },
    { id: "avatar_oracle", name: "The Oracle", description: "Possessing unparalleled insight.", cost: 5000, rarity: shopTypes_1.ItemRarity.Unique, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_oracle"], type: "avatar" },
    { id: "avatar_little_girl", name: "The Little Girl", description: "(not) Just a Little Girl.", cost: 5001, rarity: shopTypes_1.ItemRarity.Unique, imageUrl: ALL_ITEM_IMAGE_URLS["avatar_little_girl"], type: "avatar" },
];
// --- Pool of Mystery Boxes ---
const rarityOrder = [
    shopTypes_1.ItemRarity.Mainstream,
    shopTypes_1.ItemRarity.QuiteCommon,
    shopTypes_1.ItemRarity.Uncommon,
    shopTypes_1.ItemRarity.Rare,
    shopTypes_1.ItemRarity.Special,
    shopTypes_1.ItemRarity.Legendary,
    shopTypes_1.ItemRarity.Unique,
];
// Define the rarity probabilities for weighted selection
const RARITY_PROBABILITIES = {
    [shopTypes_1.ItemRarity.Mainstream]: 0.30,
    [shopTypes_1.ItemRarity.QuiteCommon]: 0.25,
    [shopTypes_1.ItemRarity.Uncommon]: 0.22,
    [shopTypes_1.ItemRarity.Rare]: 0.11,
    [shopTypes_1.ItemRarity.Special]: 0.075,
    [shopTypes_1.ItemRarity.Legendary]: 0.035,
    [shopTypes_1.ItemRarity.Unique]: 0.01,
};
...
function getPreviousRarity(currentRarity) {
    const currentIndex = rarityOrder.indexOf(currentRarity);
...
function selectRandomByRarity(items) {
    if (items.length === 0) {
        return null;
    }
...
function generateMysteryBoxes(allItems) {
    const mysteryBoxes = [];
    // Group items by rarity for easier access
    const itemsByRarity = allItems.reduce((acc, item) => {
        if (!acc[item.rarity]) {
            acc[item.rarity] = [];
        }
    ...
    for (const currentRarity of rarityOrder) {
        ...
        const availableItemsInBox = [];
        const itemIdsAdded = []; // Keep track of item IDs added to avoid duplicates
        // --- Select items for the box ---
        // 1. Item from the rarity above (5% probability)
        if (itemsOfNextRarity.length > 0 && currentRarity !== shopTypes_1.ItemRarity.Unique) {
        ...
        else if (currentRarity === shopTypes_1.ItemRarity.Unique && itemsByRarity[shopTypes_1.ItemRarity.Legendary]?.length > 0) {
            const itemFromLegendary = shuffleArray(itemsByRarity[shopTypes_1.ItemRarity.Legendary])[0];
        ...
        if (itemsOfPreviousRarity.length > 0 && currentRarity !== shopTypes_1.ItemRarity.Mainstream) {
        ...
        else if (currentRarity === shopTypes_1.ItemRarity.Mainstream && itemsByRarity[shopTypes_1.ItemRarity.QuiteCommon]?.length > 0) {
            const itemFromQuiteCommon = shuffleArray(itemsByRarity[shopTypes_1.ItemRarity.QuiteCommon])[0];
        ...
        if (availableItemsInBox.length > 0) {
            ...
            switch (currentRarity) {
                case shopTypes_1.ItemRarity.Mainstream:
                    image_url = shopTypes_1.MysterBoxImageUrls.Mainstream;
                    break;
                case shopTypes_1.ItemRarity.QuiteCommon:
                    image_url = shopTypes_1.MysterBoxImageUrls.QuiteCommon;
                    break;
                case shopTypes_1.ItemRarity.Uncommon:
                    image_url = shopTypes_1.MysterBoxImageUrls.Uncommon;
                    break;
                case shopTypes_1.ItemRarity.Rare:
                    image_url = shopTypes_1.MysterBoxImageUrls.Rare;
                    break;
                case shopTypes_1.ItemRarity.Special:
                    image_url = shopTypes_1.MysterBoxImageUrls.Special;
                    break;
                case shopTypes_1.ItemRarity.Legendary:
                    image_url = shopTypes_1.MysterBoxImageUrls.Legendary;
                    break;
                case shopTypes_1.ItemRarity.Unique:
                    image_url = shopTypes_1.MysterBoxImageUrls.Unique;
                    break;
            }
            const mysteryBox = {
...
function getMysteryBoxCostMultiplier(rarity) {
    switch (rarity) {
        case shopTypes_1.ItemRarity.Mainstream: return 1.2;
        case shopTypes_1.ItemRarity.QuiteCommon: return 1.3;
        case shopTypes_1.ItemRarity.Uncommon: return 1.4;
        case shopTypes_1.ItemRarity.Rare: return 1.5;
        case shopTypes_1.ItemRarity.Special: return 1.6;
        case shopTypes_1.ItemRarity.Legendary: return 1.8;
        case shopTypes_1.ItemRarity.Unique: return 2.0; // Unique boxes are more expensive relative to content
        default: return 1.0;
    }
}
// Helper function to determine minimum cost based on rarity
function getMinimumMysteryBoxCost(rarity) {
    switch (rarity) {
        case shopTypes_1.ItemRarity.Mainstream: return 50;
        case shopTypes_1.ItemRarity.QuiteCommon: return 100;
        case shopTypes_1.ItemRarity.Uncommon: return 200;
        case shopTypes_1.ItemRarity.Rare: return 400;
        case shopTypes_1.ItemRarity.Special: return 800;
        case shopTypes_1.ItemRarity.Legendary: return 1500;
        case shopTypes_1.ItemRarity.Unique: return 3000;
        default: return 10;
    }
}
function getDailyShopInventory(allItems, allBoxes) {
    const dailyItems = [];
    const dailyMysteryBoxes = [];
